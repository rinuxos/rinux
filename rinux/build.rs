...
fn main() -> std::io::Result<()> {
    const DEFAULT_FILE_CONFIG: &'static str = r#"This file is used for configuring Rinux
...
#QUIET(false)"#;
    const DEFAULT_FILE_BUILD: &'static str = r#"This file is used for importing your own projects into Rinux
NOT for building Rinux
...
echo Running PureOS
    ...
    pub(crate) const QUIET_BOOT: bool = {};"#,
        ...
        let mut file = File::create("./src/conf/mod.rs")?;
        file.write_all(preset(res_config_name, res_config_version, res_config_quiet).as_bytes())?;
        Ok(())
    }
